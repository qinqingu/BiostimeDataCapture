...
anna.showAlertUiDialogTitlebarClose = function () {
    $('.ui-dialog-titlebar-close').show();
};

anna.alert = function (message, closeHandler) {
    anna.prompt.show(message, closeHandler);
};

anna.disableCloseAlert = function (message, closeHandler) {
    anna.prompt.disableCloseShow(message, closeHandler);
};